                    ...
                    <div className="row mt-4">
                        <div className="col">
                            ...
                            <div className={`mt-3 ${classes.letterPreview}`}>
                                ...
                                <Typography variant="body1" className="mt-3">
                                    The CFPB now receives complaints for violations of this Order at <a href="https://www.consumerfinance.gov/complaint/" target="_blank" rel="noopener noreferrer" className={classes.textLink}>www.consumerfinance.gov/complaint/</a> or by calling 855-411-2372.
                                </Typography>
                                <Typography variant="body1" className="mt-3">
                                    Regards,<br />
                                ...
                                <Typography variant="body2" className="mt-3">
                                    _______________________<br />
                                    _______________________<br />
                                    <sup>1</sup> The original expiration of December 31, 2020 was extended to at least June 30, 2021 and may be further extended by the Coronavirus Response and Relief Supplemental Appropriations Act<br />
