                        ...
                        <div className="col">
                            ...
                            <div className={`mt-3 ${classes.letterPreview}`}>
                                ...
                                <Typography variant="body2" className="mt-3">
                                    _______________________<br />
                                    _______________________<br />
                                    <sup>1</sup> The original expiration of December 31, 2020 was extended to March 31, 2021 by the Coronavirus Response and Relief Supplemental Appropriations Act<br />
